...
CocaCola_Sales_Rawdata<-read.csv(file.choose()) # read the Airlines data
View(CocaCola_Sales_Rawdata) # Seasonality 12 months 
windows()
plot(CocaCola_Sales_Rawdata$PK...,type="o")
